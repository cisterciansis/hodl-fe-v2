    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[500px]">
                ...
                {error && (
                    <div className="p-3 text-sm text-red-600 dark:text-red-300 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-md flex items-start justify-between gap-2">
                        <span>{error}</span>
                        <Button
                            onClick={() => setError("")}
                            variant="ghost"
                            size="sm"
                            className="h-6 px-2 text-red-500 hover:text-red-700 hover:bg-red-100 dark:hover:bg-red-950/30 shrink-0"
                        >
                            Retry
                        </Button>
                    </div>
